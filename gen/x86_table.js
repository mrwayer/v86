...
const encodings = [
    ...
    { opcode: 0x9B, custom: 1, skip: 1 }, // fwait: raises #NM only when MP and TS are both set, otherwise waits for nothing
    ...
    // A string instruction's helper may put eip back on the instruction to run
    // it again, or raise a fault into the guest; the compiled form loops on the
    // first and leaves on the second, so the block need not end here.
    { opcode: 0xA4, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xF2A4, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xF3A4, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xA5, block_boundary: 0, custom: 1, is_string: 1, os: 1 },
    { opcode: 0xF2A5, block_boundary: 0, custom: 1, is_string: 1, os: 1 },
    { opcode: 0xF3A5, block_boundary: 0, custom: 1, is_string: 1, os: 1 },

    { opcode: 0xA6, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xF2A6, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xF3A6, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xA7, block_boundary: 0, custom: 1, is_string: 1, os: 1 },
    { opcode: 0xF2A7, block_boundary: 0, custom: 1, is_string: 1, os: 1 },
    { opcode: 0xF3A7, block_boundary: 0, custom: 1, is_string: 1, os: 1 },

    { opcode: 0xA8, custom: 1, imm8: 1 },
    { opcode: 0xA9, custom: 1, os: 1, imm1632: 1 },

    { opcode: 0xAA, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xF2AA, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xF3AA, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xAB, block_boundary: 0, custom: 1, is_string: 1, os: 1 },
    { opcode: 0xF2AB, block_boundary: 0, custom: 1, is_string: 1, os: 1 },
    { opcode: 0xF3AB, block_boundary: 0, custom: 1, is_string: 1, os: 1 },

    { opcode: 0xAC, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xF2AC, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xF3AC, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xAD, block_boundary: 0, custom: 1, is_string: 1, os: 1 },
    { opcode: 0xF2AD, block_boundary: 0, custom: 1, is_string: 1, os: 1 },
    { opcode: 0xF3AD, block_boundary: 0, custom: 1, is_string: 1, os: 1 },

    { opcode: 0xAE, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xF2AE, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xF3AE, block_boundary: 0, custom: 1, is_string: 1 },
    { opcode: 0xAF, block_boundary: 0, custom: 1, is_string: 1, os: 1 },
    { opcode: 0xF2AF, block_boundary: 0, custom: 1, is_string: 1, os: 1 },
    { opcode: 0xF3AF, block_boundary: 0, custom: 1, is_string: 1, os: 1 },
